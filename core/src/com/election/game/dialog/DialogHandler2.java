...
public class DialogHandler2 implements InputProcessor {
	...
	float letterDrawRate = 1/.2f;  //1 letter every .2 seconds
	private float percentage;
	private Table selectionTable;
	private Skin skin;
	
	
	public DialogHandler2(DialogContainer dialogContainer, BitmapFont font, BitmapFont selectedFont){
		init();
